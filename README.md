...
I am a passionate Information Technology graduate with a focus on building interactive experiences and secure systems. Whether I'm scripting game mechanics in Lua or hunting for flags in a CTF, I love solving complex problems with clean code.
...
### [Tinig Katutubo(Private)](https://github.com/kyousukehsm/TinigKatutubo)
...
### [Real-time Chat API(Private)](https://github.com/kyousukehsm/chatapi)
* **Description:** Developed a custom backend infrastructure designed for high-concurrency messaging
* **Role:** Developer (External Consultant)
